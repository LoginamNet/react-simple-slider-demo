    ...
    >
      ...
      <div className={styles.social}>
        ...
        <Link className={styles.button_link} href="mailto:loginamnet@gmail.com">
          <svg width="50" height="50" viewBox="0 -2.5 5 5">
            <path
              fill="#000"
              fillRule="evenodd"
        ...
        <Link className={styles.button_link} href="https://t.me/LoginamNet">
          <svg width="50" height="50" viewBox="0 0 6 6">
        ...
        >
          <svg width="50" height="50" viewBox="-1.5 0 4.75 4.75">
        ...
        >
          <svg width="50" height="50" fill="none" viewBox="0 0 3.75 3.75">
            <path
              fill="#000"
              fillRule="evenodd"
