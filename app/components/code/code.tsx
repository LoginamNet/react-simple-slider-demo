  ...
  return (
    <pre className={styles.code}>
      <div>
        ...
        {(sliderProps.customPrevButtonFN || sliderProps.customNextButtonFN) && (
          <br />
        )}
        ...
        {(sliderProps.notInfinite ||
          ...
          (sliderProps.butonMargin && sliderProps.butonMargin !== 30) ||
          (sliderProps.arrowColor && sliderProps.arrowColor !== "#000000")) && (
          <div>
            {`        `}
